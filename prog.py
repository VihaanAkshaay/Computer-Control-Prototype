...
tool_node = ToolNode(tools=[image_tool, click_tool, type_tool, load_image_tool, load_and_analyze_tool, open_app_tool, go_website_tool, pause_tool])

graph_builder.add_node("tools", tool_node)

llm = ChatOpenAI(temperature=0.3, model="gpt-4o")
#llm_with_tools = llm.bind_tools(tools=[search_tool, image_tool])
llm_with_tools = llm.bind_tools(tools=[image_tool, click_tool, type_tool, load_image_tool, load_and_analyze_tool, open_app_tool, go_website_tool, pause_tool])
